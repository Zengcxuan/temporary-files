...
public class StkInputActivity extends Activity implements View.OnClickListener,
    ...
    public void onClick(View v) {
	  ...
	  // End added by donghai.wu  for XR6154319   on 2018/09/28
        ...
        cancelTimeOut();
	  // Begin added by donghai.wu  for XR6154319   on 2018/09/28
	  StkUtils.getInstance().setCancelFlag(v.getId());
	  // End added by donghai.wu  for XR6154319   on 2018/09/28
    ...
    public void onCreate(Bundle icicle) {
	  ...
	  // Begin added by donghai.wu  for XR6625994   on 2018/09/28
	  Button cancelButton = (Button) findViewById(R.id.button_cancel);
	  StkUtils.getInstance().setOrangeInputComponent(this, R.id.button_cancel, cancelButton,actionBar);
	  // End added by donghai.wu  for XR6625994   on 2018/09/28
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (!mAcceptUsersInput) {
            CatLog.d(LOG_TAG, "mAcceptUsersInput:false");
	      // Begin added by donghai.wu  for XR6625818     on 2018/09/28
	      if(keyCode == KeyEvent.KEYCODE_HOME) {
                CatLog.d(LOG_TAG, "onKeyDown, finish");
                sendResponse(StkAppService.RES_ID_END_SESSION);
                finish();
    ...
    private void configInputDisplay() {
        ...
        case STATE_TEXT:
            ...
            if (mStkInput.defaultText != null) {
             ...
             // Begin added by donghai.wu  for XR6154319   on 2018/09/28
            StkUtils.getInstance().setInputComponent(mStkInput,mTextIn,numOfCharsView,inTypeView,maxLen);
	      // End added by donghai.wu  for XR6154319   on 2018/09/28
            break;
        case STATE_YES_NO:
    ...
    @Override
    public void finish() {
       StkUtils.getInstance().cancelNotification("input");
       super.finish();
    }
    // End added by donghai.wu  for XR6154319   on 2018/09/28
}
