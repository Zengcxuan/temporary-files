...
//Begin added by cong.tao.hz for XR7046534 tclPlugin telecomcode on 2018/10/11
import com.tcl.plugin.ITclFdnCallback;
import com.tcl.plugin.TclPluginManager;
import com.tcl.plugin.ITclApnCallback;
//End added by cong.tao.hz for XR7046534 tclPlugin telecomcode on 2018/10/11
...
public class DcTracker extends Handler {
    ...
    //Begin added by cong.tao.hz for XR7046534 tclPlugin telecomcode on 2018/10/11
    private static final String REASON_FDN_ENABLED = "FdnEnabled";
    private static final String REASON_FDN_DISABLED = "FdnDisabled";
    //End added by cong.tao.hz for XR7046534 tclPlugin telecomcode on 2018/10/11
   ...
   //Begin modify by kai.du for XR7133765 telecomcode  on 2018/12/04
    protected DcTesterFailBringUpAll mDcTesterFailBringUpAll;
    protected DcController mDcc;
    //End modify by kai.du for XR7133765 telecomcode  on 2018/12/04
    ...
    // Begin added by shengjiao.liu.hz for XR6031617 telecomcode on 2018/10/04
    public static final String TCL_ACTION_SIM_SERVICE_UPDATED = "TCL_ACTION_SIM_SERVICE_UPDATED";
    // End modified by shengjiao.liu.hz for XR6031617 telecomcode on 2018/10/04
    ...
    private final BroadcastReceiver mIntentReceiver = new BroadcastReceiver () {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            //Begin added by shengjiao.liu.hz for XR6031617 telecomcode on 2018/10/04
            else if(action.equals(TCL_ACTION_SIM_SERVICE_UPDATED)){
                int intentSubId = intent.getIntExtra("SubId", 0);
                if(DBG) log("Receive action = " + action + "SubId is :" + intentSubId + "PhonSubId is : " + mPhone.getSubId());
                if(intentSubId == mPhone.getSubId()) {
                    onApnChanged();
                    sendRestartRadio();
                }
            }
            //End added by shengjiao.liu.hz for XR6031617 telecomcode on 2018/10/04
            else {
    ...
    private final OnSubscriptionsChangedListener mOnSubscriptionsChangedListener =
            new OnSubscriptionsChangedListener() {
                ...
                public void onSubscriptionsChanged() {
                    ...
                    //Begin added by shengjiao.liu.hz for XR6048984 telecomcode on 2018/10/04
                    //For the performance improvement
                    //if the current subId has been changed from previous subId,registerSettingsObserver
                    ...
                    //End added by shengjiao.liu.hz for XR6048984 telecomcode on 2018/10/04
                }
            };
    ...
    public DcTracker(Phone phone) {
        ...
        //Begin added by shengjiao.liu.hz for XR6031617 telecomcode on 2018/10/04
        filter.addAction(TCL_ACTION_SIM_SERVICE_UPDATED);
        //End added by shengjiao.liu.hz for XR6031617 telecomcode on 2018/10/04
        ...
        //Begin added by cong.tao.hz for XR7046534 tclPlugin telecomcode on 2018/10/11
        TclPluginManager.getTclFdn(mPhone.getPhoneId()).initDcTracker(mPhone.getContext(), mPhone.getPhoneId(), mDataConnectionTracker, mFdnCallback);
        //End added by cong.tao.hz for XR7046534 tclPlugin telecomcode on 2018/10/11
    }
    ...
    public void dispose() {
        ...
        //Begin added by cong.tao.hz for XR7046534 tclPlugin telecomcode on 2018/10/11
        TclPluginManager.getTclFdn(mPhone.getPhoneId()).disposeDcTracker();
        //End added by cong.tao.hz for XR7046534 tclPlugin telecomcode on 2018/10/11
    }
        ...
        synchronized (mDataEnabledSettings) {
            if (mDataEnabledSettings.isUserDataEnabled() != enabled) {
                ...
                if (TelephonyManager.getDefault().getSimCount() == 1) {
                    ...
                    //Begin added by yangning.hong.hz for XR7100166 tclPlugin telecomcode on 2018/11/09
                    TclPluginManager.getTclNetworkSettings(mPhone.getContext())
                            .setDataEnabled(enabled, mPhone.getSubId());
                    //End added by yangning.hong.hz for XR7100166 tclPlugin telecomcode on 2018/11/09
                } else {
                    int phoneSubId = mPhone.getSubId();
    ...
    boolean isDataAllowed(ApnContext apnContext, DataConnectionReasons dataConnectionReasons) {
        ...
        //Begin added by cong.tao.hz for XR7046534 tclPlugin telecomcode on 2018/10/11
        if (TclPluginManager.getTclFdn(mPhone.getPhoneId()).isFdnEnabled() && 
                !TclPluginManager.getTclFdn(mPhone.getPhoneId()).hasStar99Pound()) {
            reasons.add(DataDisallowedReasonType.FDN_ENABLED);
        }
        //End added by cong.tao.hz for XR7046534 tclPlugin telecomcode on 2018/10/11
    ...
    protected boolean cleanUpAllConnections(boolean tearDown, String reason) {
        ...
        if (!TextUtils.isEmpty(reason)) {
            disableMeteredOnly = reason.equals(Phone.REASON_DATA_SPECIFIC_DISABLED) ||
                    ...
                    reason.equals(REASON_FDN_ENABLED);//Modified by cong.tao.hz for XR7046534 tclPlugin telecomcode on 2018/10/11
        }
    ...
    public ApnSetting fetchDunApn() {
        ...
        //Begin deleted by shengjiao.liu.hz for XR6840801 telecomcode on 2018/08/27
        // Use the apn from TCL clid not the frameworks's xml
        ...
        //End deleted by shengjiao.liu.hz for XR6840801 telecomcode on 2018/08/27
        ...
        for (ApnSetting dunSetting : dunCandidates) {
            ...
            if (dunSetting.numeric.equals(operator)) {
                if (dunSetting.hasMvnoParams()) {
                    //Begin modified by shengjiao.liu.hz for XR6840801 telecomcode on 2018/08/27
                    //if (r != null && ApnSetting.mvnoMatches(r, dunSetting.mvnoType,
                            //dunSetting.mvnoMatchData)) {
                    if (r != null) {
                        boolean isMatched = ApnSetting.mvnoMatches(r, dunSetting.mvnoType, dunSetting.mvnoMatchData);
                        boolean tclMatched = TclPluginManager.getTclApnSettings(mPhone.getContext()).mvnoMatches(
                            r, dunSetting.mvnoType, dunSetting.mvnoMatchData, mPhone.getSubId(), isMatched);
                        if(tclMatched) {
                            retDunSetting = dunSetting;
                            break;
                        }
                    }
                //End modified by shengjiao.liu.hz for XR6840801 telecomcode on 2018/08/27    
    ...
    private ApnSetting makeApnSetting(Cursor cursor) {
        ...
        //Begin added by shengjiao.liu.hz for XR6015039 telecomcode on 2018/10/04
        Boolean setProtocolForEmergency = false;
        String emergencyApnProtocol = "IPV4V6";
        if (ArrayUtils.contains(types, PhoneConstants.APN_TYPE_EMERGENCY)) {
            setProtocolForEmergency = true;            
            emergencyApnProtocol = mPhone.getContext().getResources().getString(
                     com.tct.internal.R.string.def_set_emergency_apn_protocol);
        }
        //End added by shengjiao.liu.hz for XR6015039 telecomcode on 2018/10/04
        ApnSetting apn = new ApnSetting(
                ...
                setProtocolForEmergency ? emergencyApnProtocol : cursor.getString(
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                if (apn.hasMvnoParams()) {
                    //Begin modified by shengjiao.liu.hz for apn telecomcode on 2018/08/27
                    /*if (r != null && ApnSetting.mvnoMatches(r, apn.mvnoType, apn.mvnoMatchData)) {
                        mvnoApns.add(apn);
                    }*/
                    if (r != null) {
                        int filterResult = TclPluginManager.getTclApnSettings(mPhone.getContext()).
                                filterAPN(r, apn.mvnoType, apn.mvnoMatchData, mPhone.getContext(), mPhone.getSubId());
                        if (filterResult == 1) {
                            mvnoApns.add(apn);
                        ...
                        else if(filterResult == -1 && ApnSetting.mvnoMatches(r, apn.mvnoType, apn.mvnoMatchData)) {
                            mvnoApns.add(apn);
                        }
                    }
                    //End modified by shengjiao.liu.hz for apn telecomcode on 2018/08/27
                } else {
                    mnoApns.add(apn);
                }
    ...
    private boolean retryAfterDisconnected(ApnContext apnContext) {
        ...
        if ( Phone.REASON_RADIO_TURNED_OFF.equals(reason) ||
                REASON_FDN_ENABLED.equals(reason) || /*Added by cong.tao.hz for XR7046534 tclPlugin telecomcode on 2018/10/11*/
    ...
    public boolean getDataEnabled() {
        ...
        if (TelephonyManager.getDefault().getSimCount() == 1) {
            retVal = Settings.Global.getInt(mResolver, Settings.Global.MOBILE_DATA,
                    retVal ? 1 : 0) != 0;
            //Begin added by yangning.hong.hz for XR7100166 tclPlugin telecomcode on 2018/11/09
            retVal = TclPluginManager
                .getTclNetworkSettings(mPhone.getContext()).getDataEnabled(mPhone.getSubId(), retVal);
            //End added by yangning.hong.hz for XR7100166 tclPlugin telecomcode on 2018/11/09
        } else {
            int phoneSubId = mPhone.getSubId();
            try {
        ...
        //Begin deleted by yangning.hong.hz for XR7100166 telecomcode on 2018/11/09
        //Merge from XR6209960,6181727
        ...
        //End deleted by yangning.hong.hz for XR7100166 telecomcode on 2018/11/09
    ...
    public boolean getDataRoamingEnabled() {
        ...
        //Begin added by zubin.chen.hz for roaming tclPlugin telecomcode on 2018/08/08
        isDataRoamingEnabled = TclPluginManager.getTclRoaming(mPhone.getContext())
                .getDataRoamingEnabled(mPhone.getSubId(), isDataRoamingEnabled);
        //End added by zubin.chen.hz for roaming tclPlugin telecomcode on 2018/08/08
...
//Begin added by zubin.chen.hz for XR7172613 telecomcode on 2018/12/17 
         /*   try {
...
//End added by zubin.chen.hz for XR7172613 telecomcode on 2018/12/17 
        } else if (!isDataRoamingFromUserAction()) {
            //Begin modified by shengjiao.liu.hz for XR7152156 telecomcode on 2018/12/08
            try {
                Settings.Global.getInt(mResolver, setting);
            } catch (SettingNotFoundException e) {
            ...
            //End modified by shengjiao.liu.hz for XR7152156 telecomcode on 2018/12/08
        }
    ...
    protected DcAsyncChannel createDataConnection() {   //modify by kai.du for XR7133765 telecomcode  on 2018/12/04
    ...
    public void handleMessage (Message msg) {
        ...
        switch (msg.what) {
            case DctConstants.EVENT_RECORDS_LOADED:
                ...
                //Begin added by cong.tao.hz for XR7046534 tclPlugin telecomcode on 2018/10/11
                TclPluginManager.getTclFdn(mPhone.getPhoneId()).onRecordsLoaded();
                //End added by cong.tao.hz for XR7046534 tclPlugin telecomcode on 2018/10/11
                break;
    ...
    private void updateDataActivity() {
        ...
        //Begin added by shengjiao.liu.hz for XR6346181 telecomcode on 2018/08/21
        updateTxRxSum(curTxRxSum);
        //End added by shengjiao.liu.hz for XR6346181 telecomcode on 2018/08/21
    ...
    private void updateDataStallInfo() {
        ...
        //Begin added by shengjiao.liu.hz for XR6346181 telecomcode on 2018/08/21
        updateTxRxSum(mDataStallTxRxSum);
        //End added by shengjiao.liu.hz for XR6346181 telecomcode on 2018/08/21
    ...
    private void updateTxRxSum(TxRxSum aTxRxSum) {
        if (!TextUtils.equals(TelephonyManager.getDefault().getSimOperatorNumericForPhone(mPhone.getPhoneId()), "732101")) {
            return;
        }
        ...
        if (txUpdated) aTxRxSum.txPkts = txSum;
        if (rxUpdated) aTxRxSum.rxPkts = rxSum;
    }
    //End added by shengjiao.liu.hz for XR6346181 telecomcode on 2018/08/21

    //Begin added by cong.tao.hz for XR7046534 tclPlugin telecomcode on 2018/10/11
    private ITclFdnCallback mFdnCallback = new ITclFdnCallback() {   
        @Override
        public void setupDataOnConnectableApnsCallback(String reason) {
            setupDataOnConnectableApns(reason);
        }

        @Override
        public void cleanUpAllConnectionsCallback(boolean tearDown, String reason) {
