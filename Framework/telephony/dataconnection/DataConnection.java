...
//Begin added by kai.du for XR6625982 tclPlugin telecomcode on 2018/10/04
import com.tcl.plugin.TclPluginManager;
//End added by kai.du for XR6625982 tclPlugin telecomcode on 2018/10/04
...
public class DataConnection extends StateMachine {
    ...
    private void checkSetMtu(ApnSetting apn, LinkProperties lp) {
        ...
        //Begin added by kai.du for XR7168127 tclPlugin telecomcode on 2018/12/06
        int mtuFromSDM = TclPluginManager.getTclApnSettings(mPhone.getContext()).setMtu(PhoneConstants.UNSET_MTU, apn.protocol);
        if (mtuFromSDM != PhoneConstants.UNSET_MTU) {
            lp.setMtu(mtuFromSDM);
            if (DBG) log("MTU set by  SDM : " + mtuFromSDM);
            return;
        }
        //End added by kai.du for XR7168127 tclPlugin telecomcode on 2018/12/06
    ...
    protected DataConnection(Phone phone, String name, int id,  //modify by kai.du for XR7133765 telecomcode  on 2018/12/04
                DcTracker dct, DcTesterFailBringUpAll failBringUpAll,
                DcController dcc) {
    ...
    private void tearDownData(Object o) {
        ...
        if (apnContext != null) apnContext.requestLog(str);
            ...
            //Begin add by kai.du for XR7167324 telecomcode  on 2018/12/05
           //[HOMO] GPRS DETACH is not completing successfully,for TTelefonica  and Claro Peru requirement 
            if(ResUtils.getBoolean(mPhone.getContext(),"def_noPdpDeactivate_whenPoweroff",false)){
               if ((discReason == RILConstants.DEACTIVATE_REASON_RADIO_OFF)  ){
                      AsyncResult ar = new AsyncResult(o, null, null);
                      sendMessage(obtainMessage(EVENT_DEACTIVATE_DONE, ar));
                      if (DBG) log("noPdpDeactivate when poweroff");
                      return;
                }
            }
           //End add by kai.du for XR7167324 telecomcode  on 2018/12/05
     ...
     */
    protected void notifyDisconnectCompleted(DisconnectParams dp, boolean sendAll) {  //modify by kai.du for XR7133765 telecomcode  on 2018/12/04
        ...
        public boolean processMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case EVENT_LOST_CONNECTION:
                    ...
                    break;
                //Begin add by kai.du for XR7133765 telecomcode  on 2018/12/04
                ...
                if (DBG) {
				 ...
				 break;
                //End add by kai.du for XR7133765 telecomcode  on 2018/12/04
     ...
     */
    protected class DcInactiveState extends State {  //modify by kai.du for XR7133765 telecomcode  on 2018/12/04
                ...
                //Begin add by kai.du for XR7133765 telecomcode  on 2018/12/04
                 ...
                 if (mConnectionParams != null) {
                     if (initConnection(mConnectionParams)) {
                         ...
                         if (DBG) {
                             log("DcInactiveState: msg.what=EVENT_RETRY_CONNECTION  initConnection failed");
                           }
                     }
                 }
                 retVal = HANDLED;
    ...
    //Begin add by kai.du for XR7133765 telecomcode  on 2018/12/04
     ...
     protected boolean isPdpRejectCause(DcFailCause cause) {
        return (cause == DcFailCause.USER_AUTHENTICATION
    || cause == DcFailCause.SERVICE_OPTION_NOT_SUBSCRIBED);
    }
    
    protected boolean isPdpRejectConfigEnabled() {
        return  ResUtils.getBoolean(mPhone.getContext(),"def_telcel_clear_code_function",false);
    }
    //Begin add by kai.du for XR7133765 telecomcode  on 2018/12/04
