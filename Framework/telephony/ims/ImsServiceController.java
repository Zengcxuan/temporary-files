...
public class ImsServiceController {
    ...
    class ImsServiceConnection implements ServiceConnection {
        ...
        public void onServiceDisconnected(ComponentName name) {
            ...
            //Begin modified by quantai.zhu for XR7215228 telecomcode on 2018/12/12
            // Begin modified by guoqi.zou for XR7229194 telecomcode on 2018/12/20
            try {
                if (mIImsServiceController != null && mImsServiceControllerBinder != null) {
                    mImsServiceControllerBinder.unlinkToDeath(mImsDeathRecipient, 0);
                }
            } catch (NullPointerException e) {
                e.printStackTrace();
            }
            // End modified by guoqi.zou for XR7229194 telecomcode on 2018/12/20
            //End modified by quantai.zhu for XR7215228 telecomcode on 2018/12/12
            notifyAllFeaturesRemoved();
            cleanUpService();
