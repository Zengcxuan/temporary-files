...
//Begin added by quantai.zhu for XR7037496 telecomcode on 2018/07/20
import com.tcl.plugin.TclPluginManager;
//End added by quantai.zhu for XR7037496 telecomcode on 2018/07/20
...
public final class GsmSMSDispatcher extends SMSDispatcher {
    ...
    public void sendText(String destAddr, String scAddr, String text, PendingIntent sentIntent,
        ...
        //Begin added by quantai.zhu for XR7037496 telecomcode on 2018/07/20
        pdu = TclPluginManager.getTclSmsEncoder().getSubmitPdu(mContext, pdu,
                scAddr, destAddr, text, (deliveryIntent != null),
                null, 0, 0, 0,
                sentIntent == null ? "" : sentIntent.getCreatorPackage());
        //End added by quantai.zhu for XR7037496 telecomcode on 2018/07/20
    ...
    protected SmsTracker getNewSubmitPduTracker(String destinationAddress, String scAddress,
        ...
        //Begin added by quantai.zhu for XR7037496 telecomcode on 2018/07/20
        pdu = TclPluginManager.getTclSmsEncoder().getSubmitPdu(mContext, pdu,
                scAddress, destinationAddress, message, (deliveryIntent != null),
                SmsHeader.toByteArray(smsHeader), encoding, smsHeader.languageTable, smsHeader.languageShiftTable,
                sentIntent == null ? "" : sentIntent.getCreatorPackage());
        //End added by quantai.zhu for XR7037496 telecomcode on 2018/07/20
