...
//Begin added by zubai.li for XR7040178 telecomcode on 2018/09/28
import com.tcl.plugin.TclPluginManager;
//End added by zubai.li for XR7040178 telecomcode on 2018/09/28
...
*/
    ...
    public static GsmMmiCode newFromDialString(String dialString, GsmCdmaPhone phone,
        ...
        Matcher m;
        GsmMmiCode ret = null;
        //Begin Added by yong.wei for FR6622840 tclPlugin telecomcode on 2018/09/30
        if(dialString != null && phone != null && !phone.isInCall()
                && TclPluginManager.getTclUssd(phone.getContext()).isNormalCall(dialString)){
            return ret;
        }
        //End Added by yong.wei for FR6622840 tclPlugin telecomcode on 2018/09/30
...
*/
    ...
    onSetComplete(Message msg, AsyncResult ar){
        ...
        if (ar.exception != null) {
            ...
            mState = State.COMPLETE;
            //Begin modified by zubai.li for XR7040178 telecomcode on 2018/09/28
            /*
            sb.append(mContext.getText(
                    com.android.internal.R.string.serviceRegistered));
            */
            sb.append(TclPluginManager.getTclUssd(mContext).getRegisterSc(mSc, mContext.getText(
                    com.android.internal.R.string.serviceRegistered)));
            //End modified by zubai.li for XR7040178 telecomcode on 2018/09/28
        } else if (isErasure()) {
            mState = State.COMPLETE;
            sb.append(mContext.getText(
