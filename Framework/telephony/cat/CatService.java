    ...
    private void handleCommand(CommandParams cmdParams, boolean isProactiveCmd) {
        ...
        switch (cmdParams.getCommandType()) {
            ...
            case ACTIVATE:
                ...
                sendTerminalResponse(cmdParams.mCmdDet, resultCode, false, 0 ,null);
                break;
            //Begin modified by yangning.hong.hz for XR7100436 telecomcode on 2018/11/29
            //Begin added by donghai.wu for XR6701073 telecomcode  on 2018/09/28
            case LANGUAGE_NOTIFICATION:
                //No hard requirement to do anything as per spec, just return OK
                sendTerminalResponse(cmdParams.mCmdDet, ResultCode.OK, false, 0 ,null);
                return;//No need to start STK app here, just send the TR to modem.
            //End added by donghai.wu for  XR6701073 telecomcode  on 2018/09/28
            //End modified by yangning.hong.hz for XR7100436 telecomcode on 2018/11/29
            default:
        ...
        case MSG_ID_REFRESH:
            ...
            if (msg.obj != null) {
                ...
                if (ar != null && ar.result != null) {
			     ...
			     // Begin added by donghai.wu  for XR6154319  telecomcode  on 2018/09/28
                        TclPluginManager.getTclStk(mContext).judgeSetupMenu(mSlotId,data);
                        //End added by donghai.wu  for XR6154319  telecomcode  on 2018/09/28
                    } catch (ClassCastException e) {
                        break;
                    }
