...
//Begin add by zubai.li for XR7051329,7115310 telecomcode on 2018/12/06
import com.tcl.plugin.TclPluginManager;
//End add by zubai.li for XR7051329,7115310 telecomcode on 2018/12/06
...
public class ImsPhoneCallTracker extends CallTracker implements ImsPullCall {
    ...
    public int getDisconnectCauseFromReasonInfo(ImsReasonInfo reasonInfo, Call.State callState) {
        ...
        switch (code) {
            ...
            case ImsReasonInfo.CODE_IMEI_NOT_ACCEPTED:
                //Begin add by zubai.li for XR7051329,7115310 telecomcode on 2018/12/06
                if (mIsInEmergencyCall) {
                    int returnCause = TclPluginManager.getTclCallsManager(null).disconnectCauseCustomize(mPhone.getServiceState().getState());
    ...
    private void handleFeatureCapabilityChanged(int serviceClass,
        ...
        if (serviceClass == ImsServiceClass.MMTEL) {
            ...
            //Begin added by quan.luo for XR7201474 on 2018/12/13
            TclPluginManager.getTclImsManager(mPhone.getContext()).broadcastImsStateChanged(mPhone.getServiceState().getState());
            //End added by quan.luo for XR7201474 on 2018/12/13
        }
    }
