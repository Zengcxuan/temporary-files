...
import com.tcl.plugin.TclPluginManager;//Added by wensen.luo for XR6627896 tclplugin telecomcode on 2018/08/01
    ...
    private void responseOperatorInfos(RadioResponseInfo responseInfo,
        ...
        if (rr != null) {
            ...
            for (int i = 0; i < networkInfos.size(); i++) {
                //Begin added by wensen.luo for XR6627896 tclplugin telecomcode on 2018/08/01
                TclPluginManager.getCustomizeNetworkSearch(mRil.mContext)
                        .CustomizeNetworkSearchDisplay(mRil.mPhoneId, networkInfos.get(i));
                //End added by wensen.luo for XR6627896 tclplugin telecomcode on 2018/08/01
