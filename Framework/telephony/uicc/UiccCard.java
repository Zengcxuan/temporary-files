...
//Begin added by donghai.wu for XR7229003  on 2018/12/19
import com.tcl.plugin.TclPluginManager;
//End added by donghai.wu for XR7229003  on 2018/12/19
        ...
        synchronized (mLock) {
	     ...
	     log("enter resetAppWithAid");
            ...
            if (TextUtils.isEmpty(aid)) {
                ...
                if (mCatService != null) {
		     //Begin added by donghai.wu telecomcode for XR7229003  on 2018/12/19
		     log(" resetAppWithAid  mCatService.dispose();");
		     if(TclPluginManager.getTclStk(null).isSimpleRresh()){ 
	                 log("Disposing isSimpleRresh return");
	                 return changed;
                    }
                    //End added by donghai.wu for telecomcode XR7229003  on 2018/12/19
                    mCatService.dispose();
                    mCatService = null;
                    changed = true;
                }
