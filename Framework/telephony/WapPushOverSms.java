...
// Begin added by guoqi.zou for XR7210323 tclplugin telecomcode on 2018/12/06
import com.tcl.plugin.TclPluginManager;
// End added by guoqi.zou for XR7210323 tclplugin telecomcode on 2018/12/06
...
public class WapPushOverSms implements ServiceConnection {
    ...
    public int dispatchWapPdu(byte[] pdu, BroadcastReceiver receiver, InboundSmsHandler handler) {
        ...
        // Begin added by guoqi.zou for XR7210323 tclplugin telecomcode on 2018/12/06
        if (!TclPluginManager.getTclMmsParser().dispatchAnonymousMms(mContext, result.mimeType, result.parsedPdu)) {
            Rlog.i(TAG, "Discarded Anonymous Mms");
            return Activity.RESULT_CANCELED;
        }
        // End added by guoqi.zou for XR7210323 tclplugin telecomcode on 2018/12/06

        // Begin added by lichun.xiu for XR7210326 tclplugin telecomcode on 2018/12/10
        if (!TclPluginManager.getTclMmsParser().dispatchAdvertisementMms(mContext, result.mimeType, result.parsedPdu)) {
            Rlog.i(TAG, "Discarded Advertisement Mms");
            return Activity.RESULT_CANCELED;
        }
        // End added by lichun.xiu for XR7210326 tclplugin telecomcode on 2018/12/10
