...
interface IIccPhoneBook {
    ...
    /**
     * Get the index of inserted ADN record
     */
    int getInsertRecordIndex();
    int getInsertRecordIndexForSubscriber(int subId);
    ...
    boolean isAdnLoadDone();
    boolean isAdnLoadDoneForSubscriber(int subId);
