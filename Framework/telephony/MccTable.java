...
//Begin added by yangning.hong.hz for XR7035711 7035699 tclPlugin telecomcode on 2018/09/26
import com.tcl.plugin.TclPluginManager;
//End added by yangning.hong.hz for XR7035711 7035699 tclPlugin telecomcode on 2018/09/26
...
//            }
    ...
    public static Locale getLocaleFromMcc(Context context, int mcc, String simLanguage) {
        //Begin added by yangning.hong.hz for XR7035711 7035699 tclPlugin telecomcode on 2018/09/26
        Slog.d(LOG_TAG, "before tcl custom, mcc:" + mcc);
        //custom mcc, if mcc=-1 mean not set language from sim
        mcc = TclPluginManager.getTclCustomLanguage(context).setLanguageFromSimAndCustomMcc(mcc);
        if(mcc == -1){
            return null;
        }
        Slog.d(LOG_TAG, "after tcl custom, mcc:" + mcc);
        //End added by yangning.hong.hz for XR7035711 7035699 tclPlugin telecomcode on 2018/09/26
