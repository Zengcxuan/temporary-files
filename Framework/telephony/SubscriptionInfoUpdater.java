...
//Begin added by yangning.hong.hz for XR7033654 7033655 tclPlugin telecomcode on 2018/09/22
import com.tcl.plugin.SimLockUtils;
import android.os.SystemProperties;
//End added by yangning.hong.hz for XR7033654 7033655 tclPlugin telecomcode on 2018/09/22
//Begin added by zubai.li for XR7040161 telecomcode on 2018/09/28
import com.tcl.plugin.TclPluginManager;
//End added by zubai.li for XR7040161 telecomcode on 2018/09/28
/**
 *@hide
 */
public class SubscriptionInfoUpdater extends Handler {
    ...
    //Begin added by yangning.hong.hz for XR7142434 telecomcode on 2018/12/19
    private static boolean onShutdownProcess = false;
    //End added by yangning.hong.hz for XR7142434 telecomcode on 2018/12/19
        ...
        if (isAllIccIdQueryDone()) {
            ...
            for (int subId : subIds) {
                ...
                if (subInfo != null && subInfo.getNameSource() !=
                    ...
                    TclPluginManager.getTclCustomizeplmnspn(mContext).setDisplayNameForSameOperator(mSubscriptionManager, simNumeric, slotId);
                    //End added by zubai.li for XR7040161 telecomcode on 2018/09/28
                }
                ...
                if (storedSubId != subId) {
                    ...
                    //Begin modified by quan.luo for XR7100117 telecomcode on 2018/11/13
                    ...
                    //Begin added by quan.luo for XR7046680 tclplugin on 2018/10/13
                    networkType = TclPluginManager.getTclCustomizeplmnspn(mContext).getNetworkModeForATT(networkType, subId);
                    //End added by quan.luo for XR7046680 tclplugin on 2018/10/13
                    // Set the modem network mode
                    //mPhone[slotId].setPreferredNetworkType(networkType, null);
                    //End modified by quan.luo for XR7100117 telecomcode on 2018/11/13
    ...
    protected void handleSimAbsentOrError(int slotId, String simState) {
        ...
        //Begin added by yangning.hong.hz for XR7142434 telecomcode on 2018/12/19
        if(onShutdownProcess){
            logd("slot" + slotId + " onShutdownProcess do not handleSimAbsentOrError");
            return;
        }
        //End added by yangning.hong.hz for XR7142434 telecomcode on 2018/12/19
    ...
    synchronized protected void updateSubscriptionInfoByIccId() {
        ...
        for (int i = 0; i < PROJECT_SIM_NUM; i++) {
            logd("updateSubscriptionInfoByIccId: oldIccId[" + i + "] = " + oldIccId[i] +
                    ", sIccId[" + i + "] = " + mIccId[i]);
            //Begin added by yangning.hong.hz for XR7033654 7033655 tclPlugin telecomcode on 2018/09/22
            SystemProperties.set(SimLockUtils.PROPERTY_SIM_ICCID[i], mIccId[i]);
            //End added by yangning.hong.hz for XR7033654 7033655 tclPlugin telecomcode on 2018/09/22
        }
        ...
        //Begin added by yangning.hong.hz for XR7079986 tclPlugin telecomcode on 2018/11/08
        TclPluginManager.getTclCallSmsSettings(mContext).setSmsTalkDefaultSim(subInfos, nNewCardCount);
        //End added by yangning.hong.hz for XR7079986 tclPlugin telecomcode on 2018/11/08
        ...
        SubscriptionController.getInstance().notifySubscriptionInfoChanged();
        //Begin added by yangning.hong.hz for XR7033654 7033655 tclPlugin telecomcode on 2018/09/22
        SimLockUtils.broadcastSimInfoChanged(mContext, SimLockUtils.getIntent(nNewCardCount,
                nNewSimStatus, nSubCount, PROJECT_SIM_NUM, mInsertSimState, mIccId, oldIccId));
        //End added by yangning.hong.hz for XR7033654 7033655 tclPlugin telecomcode on 2018/09/22
