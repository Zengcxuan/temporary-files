    ...
    public static void makeDefaultPhone(Context context) {
        synchronized (sLockProxyPhones) {
            if (!sMadeDefaults) {
                ...
                //Begin added by yangning.hong.hz for XR7033654 7033655 tclPlugin telecomcode on 2018/09/22
                if (!TclPluginManager.getITclDataSubSelector(sContext).init(sContext, numPhones)) {
                    Rlog.d(LOG_TAG, "TclDataSubSelector disable");
                }else {
                    Rlog.d(LOG_TAG, "TclDataSubSelector enable");
                }
                //End added by yangning.hong.hz for XR7033654 7033655 tclPlugin telecomcode on 2018/09/22
