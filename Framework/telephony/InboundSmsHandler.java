...
//Begin added by quantai.zhu for XR7040948 telecomcode on 2018/09/30
import com.tcl.plugin.TclPluginManager;
//End added by quantai.zhu for XR7040948 telecomcode on 2018/09/30
...
public abstract class InboundSmsHandler extends StateMachine {
    ...
    private int dispatchMessage(SmsMessageBase smsb) {
        ...
        //Begin added by quantai.zhu for XR7040948 telecomcode on 2018/09/30
        if(TclPluginManager.getTclVoicemail(mContext).hideNRJVvmforOrange(smsb.getOriginatingAddress(), getPhone().getPhoneId())){
            log("hide the sms from 21101");
            return Intents.RESULT_SMS_GENERIC_ERROR;
        }
        //End added by quantai.zhu for XR7040948 telecomcode on 2018/09/30
