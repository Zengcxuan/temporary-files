...
var _=t("a/a_config.js"),e=t("biz_wap/utils/ajax.js"),p=t("a/a_sign.js"),n=t("biz_common/utils/url/parse.js");
return{
484:{
...
var e=i.getElementsByTagName("span")[0],p=i.getElementsByTagName("span")[1],n=t.biz_info.original_cnt>=10?t.biz_info.original_cnt+"篇原创文章":"",l=t.biz_info.comm_sub_cnt>0?t.biz_info.comm_sub_cnt+"位朋友关注":"";
n?(e.innerHTML=n,p.innerHTML=l):l?e.innerHTML=l:t.biz_info.signature?e.innerHTML=t.biz_info.signature:_();
},
error:function(){
_();
}
