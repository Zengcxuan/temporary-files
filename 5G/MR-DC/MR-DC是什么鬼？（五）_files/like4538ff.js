...
var o="";
o=e.comment,sendRecommendAjax(t,o,5,clientShowType);
}
...
var e=el_like.getAttribute("like"),t=el_likeNum.innerHTML,o=parseInt(e)?parseInt(e):0,n=o?0:1,i=parseInt(t)?parseInt(t):0,l=opt.appmsgid||opt.mid,s=opt.itemidx||opt.idx;
if(o){
...
RetryAjax({
url:"/mp/appmsg_like?__biz="+opt.biz+"&mid="+opt.mid+"&idx="+opt.idx+"&like="+n+"&f=json&appmsgid="+l+"&itemidx="+s,
data:{
...
var t=document.documentElement.scrollTop||window.pageYOffset||document.body.scrollTop,o=window.innerHeight||document.documentElement.clientHeight,n=qs("like3").offsetTop,i=opt.appmsgid||opt.mid,l=opt.itemidx||opt.idx;
t+o>n&&n>=t&&(ajax({
url:"/mp/appmsgreport?action=appmsglikeexposure&__biz="+opt.biz+"&mid="+opt.mid+"&idx="+opt.idx+"&f=json&appmsgid="+i+"&itemidx="+l,
data:{
is_temp_url:opt.is_temp_url||0,
scene:window.source,
subscene:window.subscene,
...
var t=!1,o=e.changedTouches,n=this.scrollTop,i=this.offsetHeight,l=this.scrollHeight;
if(o.length>0){
var s=o[0]||{},m=s.clientY;
t=m>startY&&0>=n?!1:startY>m&&n+i>=l?!1:!0,t||e.preventDefault();
}
...
var t=e||{};
if(t.show){
var o=t.likeAreaDom,n=t.likeNumDom,i=document.getElementById("js_like_btn");
o&&(o.style.display=t.likeAreaDisplayValue,t.liked&&(1===appmsg_like_type?Class.addClass(o,t.className):Class.addClass(i,t.className)),
...
n&&(n.innerHTML=realLikeNum)):2===appmsg_like_type&&(n.innerHTML=dealLikeReadShow(realLikeNum));
}
}
function dealLikeReadShow(e){
var t="";
if(parseInt(e)>1e5)t="10万+";else if(parseInt(e)>1e4&&parseInt(e)<=1e5){
var o=""+parseInt(e)/1e4,n=o.indexOf(".");
t=-1===n?o+"万":o.substr(0,n)+"."+o.charAt(n+1)+"万";
...
var t=e||{};
if(t.show){
var o=t.readAreaDom,n=t.readNumDom;
o&&(o.style.display=t.readAreaDisplayValue);
var i=t.readNum||1;
1===appmsg_like_type?(parseInt(i)>1e5?i="100000+":"",n&&(n.innerHTML=i)):2===appmsg_like_type&&(n.innerHTML=dealLikeReadShow(i));
}
}
