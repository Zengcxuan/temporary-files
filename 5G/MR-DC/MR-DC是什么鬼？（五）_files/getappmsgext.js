...
if(t.mp_shop_info){
var A=t.mp_shop_info.pid||"",h=t.mp_shop_info.outer_id||"";
a=utils.extend({
pid:A,
outer_id:h,
pt:P,
...
var P=v.pt,A=v.pos_type,h=v.product_type;
...
n[A]++,y)1==y?A===AD_POS.POS_MID?(c=!0,v=t(v),D=v):0===A?(v=i(v),(h===AD_TYPE.ANDROID_APP_PRODUCT_TYPE||h===AD_TYPE.IOS_APP_PRODUCT_TYPE)&&(D=v)):3===A&&(D=v):2==y&&(A===AD_POS.POS_MID?(c=!0,
...
}(v),0===A&&9===v.material_type&&(h===AD_TYPE.MINI_GAME_PRODUCT_TYPE&&v.dest_type===AD_CONFIG.AD_DEST_TYPE.WECHAT_APPLET_DEST_TYPE&&v.game_info&&(v.biz_info.head_img=v.game_info.head_img,
v.biz_info.nick_name=v.game_info.nick_name),h!==AD_TYPE.IOS_APP_PRODUCT_TYPE&&h!==AD_TYPE.ANDROID_APP_PRODUCT_TYPE||!v.app_info||(v.biz_info.head_img=v.app_info.icon_url,
...
var D=B[H],v=!!D&&D.a_info,h=v.product_type;
if(D&&v){
if(insertAutoAdElement(v),2!==v.use_new_protocol){
if(0==v.pos_type){
if(v.new_appmsg=window.new_appmsg,v.longAppBtnText=h===AD_TYPE.IOS_APP_PRODUCT_TYPE?"查看应用":"下载应用",
v.shortAppBtnText=h===AD_TYPE.IOS_APP_PRODUCT_TYPE?"查看":"下载",js_bottom_ad_area.innerHTML=TMPL.tmpl(a_tpl,v),
...
v=_parseExpCpc(v);
var J=!1;
if(h===AD_TYPE.ANDROID_APP_PRODUCT_TYPE||h===AD_TYPE.IOS_APP_PRODUCT_TYPE)js_cpc_area.innerHTML=TMPL.tmpl(cpc_a_tpl,v),
J=!0;else{
var X=require("a/tpl/cpc_tpl.html.js"),Q=v.exp_obj.sale_text;
(h===AD_TYPE.ADD_CONTACT_PRODUCT_TYPE||h===AD_TYPE.ANDROID_APP_PRODUCT_TYPE||h===AD_TYPE.IOS_APP_PRODUCT_TYPE||h===AD_TYPE.MINI_GAME_PRODUCT_TYPE)&&(Q=v.avatarTitle),
...
mmversion.isIOS&&v.app_info&&v.app_info.url_scheme&&h===AD_TYPE.IOS_APP_PRODUCT_TYPE&&(document.getElementById("js_promotion_tag")&&(document.getElementById("js_promotion_tag").innerHTML="查看应用"),
...
v.button_action.button_text&&""!=v.button_action.button_text||(v.button_action.button_text="去逛逛");
}catch(R){
v.button_action={
...
Z=v.crt_size,(h===AD_TYPE.ANDROID_APP_PRODUCT_TYPE||h===AD_TYPE.IOS_APP_PRODUCT_TYPE)&&(J=!0);
var Q="",aa="";
...
i.indexOf("get_install_state:yes")>-1&&v.app_info.url_scheme&&(n.textContent=354==parseInt(a.crt_size)||117==parseInt(a.crt_size)||355==parseInt(a.crt_size)||568==parseInt(a.crt_size)?"进入":"进入应用");
});
...
var P=g.exp_info||{},A=P.exp_id||"",h=P.exp_value||[];
try{
h=JSON.stringify(h);
}catch(T){
h="[]";
...
var A=getClickEventPageOffset(e),h=offset.getOffset(m[0]),T=A.x-h.offsetLeft,E=A.y-h.offsetTop;
ad_click(l,c,u,g,_,y,D,n,v,d,s,o,T,E,i,r,p,f,P),log("[Ad] ad_click: type="+l+", url="+c+", rl="+u+", apurl="+g+", traceid="+_+", ticket="+y+", group_id="+D+", aid="+n+", pt="+v+", pos_type="+d+", ad_engine="+s);
}
...
o.adid=window.adid||o.adid||o.aid,new v({
btnProfile:u[0],
adData:o,
pos_type:d,
report_param:f,
...
o.adid=window.adid||o.adid||o.aid;
var v="&tid="+o.traceid+"&uin="+uin+"&key="+key+"&ticket="+(o.ticket||"")+"&__biz="+biz+"&source="+source+"&scene="+scene+"&appuin="+biz+"&aid="+o.adid+"&ad_engine="+s+"&pos_type="+d+"&r="+Math.random();
}
var P,A,h,T;
...
return ad_click(i,n,_,l,c,m,f,g,y,d,s,o,w,O,h,T,p,v,D),log("[Ad] ad_click: type="+i+", url="+n+", rl="+_+", apurl="+l+", traceid="+c+", ticket="+m+", group_id="+f+", aid="+g+", pt="+y+", pos_type="+d+", ad_engine="+s),
hideComplainBtns(),!1;
});
...
ad_click(r,l,c,m,_,u,f,n,g,d,s,a,D,v,P,A,p,o,y),log("[Ad] ad_click: type="+r+", url="+l+", rl="+c+", apurl="+m+", traceid="+_+", ticket="+u+", group_id="+f+", aid="+n+", pt="+g+", pos_type="+d+", ad_engine="+s),
!1;
}
...
utils.adOptReport(1,p.pos_type,_,n),mmversion.isWp||mmversion.isIOS||mmversion.isAndroid?JSAPI.invoke("openUrlWithExtraWebview",{
url:e,
openType:1
},function(a){
...
var f="&tid="+o.traceid+"&uin="+uin+"&key="+key+"&ticket="+(o.ticket||"")+"&__biz="+biz+"&source="+source+"&scene="+scene+"&appuin="+biz+"&aid="+o.adid+"&ad_engine="+s+"&pos_type="+d+"&exp_id="+T+"&exp_value="+E+"&r="+Math.random();
...
var _=this.aInfoMap[e.aid],o=document.createElement("div");
o.className="mpad_relative";
var p=n.nextSibling;
utils.insertAfter(o,n),o.appendChild(n);
var r=createAdFrame(o,e);
return classList.addClass(r,"mpad_absolute"),_.iframeEle=r,_.heightWidthRate=parseInt(n.style.height,10)/parseInt(n.style.width,10),
p&&o.appendChild(p),void utils.report115849(1);
}
}
var d=new Image;
d.src=urlParser.join("https://badjs.weixinbridge.com/report?id=220&level=4",{
msg:JSON.stringify({
