...
for(var E=A.exp_info.exp_value||[],O=!1,w=0,b=0;b<E.length;++b){
var x=E[b]||{};
if(1==x.exp_type&&(w=x.comm_attention_num,O=w>0),2==x.exp_type){
O=!1,w=0;
break;
}
}
A.biz_info.show_comm_attention_num=O,A.biz_info.comm_attention_num=w,D={
usename:A.biz_info.user_name,
pt:v,
url:A.url,
traceid:A.traceid,
...
A.button_action.button_text&&""!=A.button_action.button_text||(A.button_action.button_text="去逛逛");
}catch(R){
A.button_action={
...
i.indexOf("get_install_state:yes")>-1&&A.app_info.url_scheme&&(n.textContent=354==parseInt(a.crt_size)||117==parseInt(a.crt_size)||355==parseInt(a.crt_size)||568==parseInt(a.crt_size)?"进入":"进入应用");
});
...
return ad_click(i,n,o,l,c,m,f,g,y,d,s,_,w,b,T,h,p,A,D),log("[Ad] ad_click: type="+i+", url="+n+", rl="+o+", apurl="+l+", traceid="+c+", ticket="+m+", group_id="+f+", aid="+g+", pt="+y+", pos_type="+d+", ad_engine="+s),
hideComplainBtns(),!1;
});
